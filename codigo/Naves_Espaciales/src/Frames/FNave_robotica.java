...
public class FNave_robotica extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BInsertar.setBackground(new java.awt.Color(0, 204, 204));
        ...
        LFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/FondoV2F.jpg"))); // NOI18N
    ...
    private void BModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BModificarActionPerformed
        ...
        try {
            ...
            ps = conexion.prepareStatement("update nave_robotica set nombre=?,velocidadMaxima=?,capacidadCarga=?,sistemaDePropulsion=?,tipoNave=? where nombre=?");
            ...
            ps.setString(6,CNombre.getText());
    ...
    private void BInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BInsertarActionPerformed
        ...
        try {
            ...
            conexion=getConnection();
            ps = conexion.prepareStatement("insert into nave_robotica (nombre,velocidadMaxima,capacidadCarga,sistemaDePropulsion,tipoNave) values(?,?,?,?,?)");
    ...
    private void BBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BBuscarActionPerformed
        ...
        try {
            ...
            conexion=getConnection();
            ps=conexion.prepareStatement("select * from nave_robotica where nombre=?");
    ...
    private void BEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BEliminarActionPerformed
        ...
        try {
            ...
            conexion=getConnection();
            ps = conexion.prepareStatement("delete from nave_robotica where nombre=?");
            ps.setString(1,CNombre.getText());
    ...
    private void cargarF(){
        ...
        try {
            ...
            ps = conexion.prepareStatement("select * from nave_robotica");
            rs = ps.executeQuery();
    ...
    public void verificacionDeDatos(){
        ...
        try {
            ...
            String [] Nave_roboticaA={CNombre.getText(),CVelocidadMaxima.getText(), CCapacidadCarga.getText(), CSistemaDePropulsion.getText(),CTipoNave.getText()};
            Nave_robotica CL= new Nave_robotica( CNombre.getText(),Integer.parseInt(CVelocidadMaxima.getText()),Integer.parseInt(CCapacidadCarga.getText()), CSistemaDePropulsion.getText(),CTipoNave.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FNave_robotica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FNave_robotica().setVisible(true);
            }
        });
    }
