...
import Clases.Vehiculo_lancera;
...
public class Fnave_lancera extends javax.swing.JFrame {
    ...
    private void agragarModeloTabla(){
        ...
        modelotabla.addColumn("numero propulsores");
        modelotabla.addColumn("tipo carga");
    }
    ...
    private void initComponents() {
        ...
        CtipoCarga = new javax.swing.JTextField();
        CNumeroMisilesPropulsores = new javax.swing.JTextField();
        ...
        LTipoCarga = new javax.swing.JLabel();
        LNumMisilesP = new javax.swing.JLabel();
        ...
        BCargar.setBackground(new java.awt.Color(102, 0, 255));
        ...
        BModificar.setBackground(new java.awt.Color(102, 0, 255));
        ...
        BInsertar.setBackground(new java.awt.Color(102, 0, 255));
        ...
        CtipoCarga.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CtipoCargaActionPerformed(evt);
            }
        });
        Panel.add(CtipoCarga, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, 90, -1));
        Panel.add(CNumeroMisilesPropulsores, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 140, 60, -1));
        ...
        LTitulo.setForeground(new java.awt.Color(102, 0, 255));
        LTitulo.setText("Nave Lancera");
        Panel.add(LTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 10, -1, -1));
        ...
        LTipoCarga.setForeground(new java.awt.Color(255, 255, 255));
        LTipoCarga.setText("TipoCarga:");
        Panel.add(LTipoCarga, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, -1, -1));

        LNumMisilesP.setForeground(new java.awt.Color(255, 255, 255));
        LNumMisilesP.setText("NumPropulsores:");
        Panel.add(LNumMisilesP, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, -1, 30));
        ...
        LFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/FondoV3F.jpg"))); // NOI18N
    ...
    private void BModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BModificarActionPerformed
        ...
        try {
            ...
            ps = conexion.prepareStatement("update vehiculo_lancera set nombre=?,velocidadMaxima=?,capacidadCarga=?,sistemaDePropulsion=?,numeroMisilesPropulsores=?,tipoDeCarga=? where nombre=?");
            ...
            ps.setInt(5,Integer.parseInt(CNumeroMisilesPropulsores.getText()));
            ps.setString(6,CtipoCarga.getText());
    ...
    private void BInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BInsertarActionPerformed
        ...
        try {
            ...
            conexion=getConnection();
            ps = conexion.prepareStatement("insert into vehiculo_lancera (nombre,velocidadMaxima,capacidadCarga,sistemaDePropulsion,numeroMisilesPropulsores,tipoDeCarga) values(?,?,?,?,?,?)");
    ...
    private void BBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BBuscarActionPerformed
        ...
        try {
            ...
            conexion=getConnection();
            ps=conexion.prepareStatement("select * from vehiculo_lancera where nombre=?");
            ...
            if(rs.next()){
                ...
                CNumeroMisilesPropulsores.setText(String.valueOf(rs.getString("numeroMisilesPropulsores")));
                CtipoCarga.setText(rs.getString("tipoDeCarga"));
    ...
    private void BEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BEliminarActionPerformed
        ...
        try {
            ...
            conexion=getConnection();
            ps = conexion.prepareStatement("delete from vehiculo_lancera where nombre=?");
            ps.setString(1,CNombre.getText());
    ...
    private void CtipoCargaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CtipoCargaActionPerformed
      
    }//GEN-LAST:event_CtipoCargaActionPerformed
    ...
    public void limpiarCajas(){
        ...
        CNumeroMisilesPropulsores.setText(null);
        CtipoCarga.setText(null);
    ...
    private void cargarF(){
        ...
        try {
            ...
            ps = conexion.prepareStatement("select * from vehiculo_lancera");
            rs = ps.executeQuery();
    ...
    public void VerificacionDatos(){
        ...
        try {
            ...
            String [] vehiculo_lanceraA={CNombre.getText(),CVelocidadMaxima.getText(), CCapacidadCarga.getText(), CSistemaDePropulsion.getText(),CNumeroMisilesPropulsores.getText(),CtipoCarga.getText()};
            Vehiculo_lancera CL= new Vehiculo_lancera( CNombre.getText(),Integer.parseInt(CVelocidadMaxima.getText()),Integer.parseInt(CCapacidadCarga.getText()),CSistemaDePropulsion.getText(),Integer.parseInt(CNumeroMisilesPropulsores.getText()),CtipoCarga.getText());
            //modelotabla.addRow(Nave_roboticaA);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fnave_lancera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Fnave_lancera().setVisible(true);
            }
        });
    }
