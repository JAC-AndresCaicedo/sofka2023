...
public class Fnave_tripulada extends javax.swing.JFrame {
    ...
    private void agragarModeloTabla(){
        ...
        modelotabla.addColumn("numero tripulantes");
    ...
    private void initComponents() {
        ...
        CNumeroTripulantes = new javax.swing.JTextField();
        ...
        LNumTripulantes = new javax.swing.JLabel();
        ...
        BCargar.setBackground(new java.awt.Color(0, 102, 102));
        ...
        BModificar.setBackground(new java.awt.Color(0, 102, 102));
        ...
        BInsertar.setBackground(new java.awt.Color(0, 102, 102));
        ...
        Panel.add(CTarea, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, 90, -1));
        Panel.add(CNumeroTripulantes, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 140, 60, -1));
        ...
        LTitulo.setForeground(new java.awt.Color(0, 102, 102));
        LTitulo.setText("Nave Tripulada");
        ...
        LTarea.setForeground(new java.awt.Color(255, 255, 255));
        LTarea.setText("Tarea:");
        Panel.add(LTarea, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, -1, -1));

        LNumTripulantes.setForeground(new java.awt.Color(255, 255, 255));
        LNumTripulantes.setText("Num Tripulantes:");
        Panel.add(LNumTripulantes, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, -1, 30));
        ...
        LFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/FondoV4F.jpg"))); // NOI18N
    ...
    private void BModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BModificarActionPerformed
        ...
        try {
            ...
            ps = conexion.prepareStatement("update nave_tripulada set nombre=?,velocidadMaxima=?,capacidadCarga=?,sistemaDePropulsion=?,numeroTripulantes=?,tarea=? where nombre=?");
            ...
            ps.setInt(5,Integer.parseInt(CNumeroTripulantes.getText()));
            ps.setString(6,CTarea.getText());
    ...
    private void BInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BInsertarActionPerformed
        ...
        try {
            ...
            conexion=getConnection();
            ps = conexion.prepareStatement("insert into nave_tripulada (nombre,velocidadMaxima,capacidadCarga,sistemaDePropulsion,numeroTripulantes,tarea) values(?,?,?,?,?,?)");
    ...
    private void BBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BBuscarActionPerformed
        ...
        try {
            ...
            conexion=getConnection();
            ps=conexion.prepareStatement("select * from nave_tripulada where nombre=?");
            ...
            if(rs.next()){
                ...
                CNumeroTripulantes.setText(String.valueOf(rs.getString("numeroTripulantes")));
                CTarea.setText(rs.getString("tarea"));
    ...
    private void BEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BEliminarActionPerformed
        ...
        try {
            ...
            conexion=getConnection();
            ps = conexion.prepareStatement("delete from nave_tripulada where nombre=?");
            ps.setString(1,CNombre.getText());
    ...
    public void limpiarCajas(){
        ...
        CNumeroTripulantes.setText(null);
        CTarea.setText(null);
    ...
    public void VerificacionDatos(){
        ...
        try {
            ...
            String [] Nave_roboticaA={CNombre.getText(),CVelocidadMaxima.getText(), CCapacidadCarga.getText(), CSistemaDePropulsion.getText(),CNumeroTripulantes.getText(),CTarea.getText()};
            Nave_tripulada CL= new Nave_tripulada( CNombre.getText(),Integer.parseInt(CVelocidadMaxima.getText()),Integer.parseInt(CCapacidadCarga.getText()),CSistemaDePropulsion.getText(),Integer.parseInt(CNumeroTripulantes.getText()),CTarea.getText());
    ...
    private void cargarF(){
        ...
        try {
            ...
            ps = conexion.prepareStatement("select * from nave_tripulada");
            rs = ps.executeQuery();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fnave_tripulada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Fnave_tripulada().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField CNumeroTripulantes;
    ...
    private javax.swing.JLabel LNumTripulantes;
